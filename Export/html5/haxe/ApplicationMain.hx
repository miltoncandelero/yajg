...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("yajg", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("yajg", null, 0, 0);
		#end
		#else
		create (null);
		#end
	...
	public static function create (config):Void {
		...
		app.meta["build"] = "133";
		app.meta["company"] = "ElementalCode";
		app.meta["file"] = "yajg";
		app.meta["name"] = "YAJG";
		app.meta["packageName"] = "org.openfl.samples.yajg";
		...
		app.window.context.attributes.background = 10066329;
